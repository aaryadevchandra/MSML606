...
plt.savefig("successful_search_time_by_distribution.png")
plt.close()
...
plt.savefig("unsuccessful_search_time_by_distribution.png")
plt.close()
...
plt.savefig("average_chain_length_by_distribution.png")
plt.close()
...
plt.savefig("maximum_chain_length_by_distribution.png")
plt.close()